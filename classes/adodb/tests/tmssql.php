...
function tpear()
{
include_once('../../adodb/tests/DB.php');
...
?>
<a href=../../adodb/tests/tmssql.php?do=tmssql>mssql</a>
<a href=../../adodb/tests/tmssql.php?do=tpear>pear</a>
<a href=../../adodb/tests/tmssql.php?do=tadodb>adodb</a>
<?php
if (!empty($_GET['do'])) {
	$do = $_GET['do'];
	switch($do) {
