...
if (PHP_VERSION < 5) include_once('../../adodb/adodb-pear.inc.php');
//--------------------------------------------------------------------------------------
...
*/
 ...
 //	$db->debug=true;
	...
	include_once "../../adodb/tests/PEAR.php";
...
include("../../adodb/rsfilter.inc.php");
...
Test <a href=../../adodb/tests/test4.php>GetInsertSQL/GetUpdateSQL</a> &nbsp; 
	<a href=../../adodb/tests/testsessions.php>Sessions</a> &nbsp;
	<a href=../../adodb/tests/testpaging.php>Paging</a> &nbsp;
	<a href=../../adodb/tests/test-perf.php>Perf Monitor</a><p>
<?php
...
include_once('../../adodb/tests/testdatabases.inc.php');
